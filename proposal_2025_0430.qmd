...
:::{.notes}
We started in these early studies with ecological momentary assessment or EMA as our sensing data stream.
...
I also want to bring your attention to the day model in red because from here on out I will only be focussing on day level models. This is for a couple reasons and I am happy to talk more about why I landed on this prediction window width later in our discussion.
:::
...
:::{.notes}
Next I want to talk introduce two follow up studies for building on the overall goal of developing a fair, accurate, and helpful algorithm that could be used in a recovery monitoring and support system.
:::
...
These studies come from a new sensing data set that I am really excited about. It contains sensing data and opioid lapse reports from a national sample of individuals in early recovery for opioid use disorder.
:::
