...
- Pleasantness and Unpleasantness of experience
- Helpfulness and harmfulness to recovery
...
The 24-hour prediction windows roll day-by-day starting at 6 am in the participant’s own time zone. 
...
1. <span style="color: #c5050c;">**Evaluate the performance of personalized state-space models that predict immediate opioid lapse risk from geolocation and daily surveys.**
...
- Predict immediate (i.e., in the next 24 hours) lapses back to opioid use
- 24-hour prediction windows roll day-by-day (6am to 6am)
- First label starts on day 14
- State-space model trained on individual data
...
:::{.notes}
So up until this point I have only been focussed on using traditional machine learning approaches for predicting lapses. While machine learning has a lot of benefits as mentioned earlier for predicting complex clinical phenomena there are also limitations.

The most notable, when it comes to predicting infrequent outcomes like lapses, is that the models are not built using an individuals own data. 
...
:::{.column width = "80%"}
::: {.fragment}
- Lapses in the next 2 weeks and next 1 month
- Model contrasts: immediate vs. 2 weeks, immediate vs. 1 month, 2 weeks vs. 1 month
