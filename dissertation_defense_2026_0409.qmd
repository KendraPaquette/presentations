...
Initial treatments, including medication and evidence-based psychosocial interventions, are effective. Unfortunately, many individuals never receive treatment. An estimated 1 in 10 individuals with a substance use disorder will receive any form of treatment. 

And for those who do, engagement in treatment is often brief and episodic. Most receive care when they are symptomatic and already at a high risk of harm. Furthermore, traditional treatments are time limited, resources are stretched thin, and providers are operating at or above full capacity. As a result patients often leave treatment without proper supports in place. Resulting in a  a “revolving door” pattern in which individuals cycle repeatedly through acute episodes of care 
...
Stark contrast to how we treat other chronic conditions, like diabetes and hypertension. 
:::
...
:::{.fragment}
- Lapses are preceded by high-risk situations
:::

:::{.fragment}
- High-risk situations differ between individuals and within an individual over time
:::
...
:::{.notes}
Lapses are instances of goal-inconsistent substance use. For example any use when the goal is abstinence or use that exceeds one’s set limit if the goal is moderation. Lapses are expected and can occur at any point during recovery. On their own necessarily indicate relapse or a full return to previous patterns of use. However, lapses are often an early warning sign of relapse. 
And maladaptive responses to lapses can undermine recovery. For example, the abstinence violation effect is a well-studied phenomenon where someone who views a lapse as a failure is more likely to continue using substances after an initial lapse.

We can also see how important lapse prevention is when looking at the opioid crisis where a single lapse could result in an overdose. 

So, predicting lapses before they occur may be an important step in preventing relapse, treating SUDS


There is an extant relapse prevention literature that characterizes the chronic non-linear nature of lapse, relapse, and recovery. This literature suggests that relapse is a fluctuating process, beginning prior to and extending beyond the return to substance use
It also posits that lapses are preceded by a high-risk situation (e.g., emotional or cognitive states, environmental contingencies, physiological states) 
These situations, if recognized, could be effective targets for treatments and interventions already known to be effective. 
Importantly, high-risk situations differ between individuals and within an individual over-time. As such, identifying imminent risk of lapse is complex and traditional approaches to treatment may not be effective on their own for monitoring risk with the intention to provide treatment and intervention just-in-time, or before a lapse occurs.

Recovery from substance use disorders is a non-linear and dynamic process (K. Witkiewitz & Marlatt, 2004). Lapses back to substance use are common and, on their own, do not necessarily constitute relapse (i.e., a full return to problematic use). Nevertheless, lapses must precede relapse and therefore can be viewed as early warning signs, making them clinically meaningful targets for intervention and prevention.

An extant relapse prevention literature has identified a range of intrapersonal precursors to lapse and relapse. These include self‑efficacy (i.e., confidence in one’s ability to maintain abstinence), craving, motivation, emotional states, and coping‑related or substance‑use behaviors (Marlatt & Donovan, 2007; K. A. Witkiewitz & Marlatt, 2007; K. Witkiewitz & Marlatt, 2004). These risk factors differ across individuals and within an individual over time. They interact with one another and with interpersonal and environmental situations to influence lapse risk (Stanton, 2005; K. Witkiewitz & Marlatt, 2004). For example, cravings are typically short-lived urges. Individuals in recovery-supportive environments may be able to ride out these cravings successfully. However, in unsupportive environments (e.g., locations with easily available alcohol or exposure to other substance-related cues), the likelihood of lapse increases. Given the complex, interactive, and time-varying nature of lapse risk, self-monitoring is difficult.
